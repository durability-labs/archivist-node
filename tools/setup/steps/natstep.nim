  ...
  return ChoiceQuestion(
    ...
    options: @[
      ...
      ChoiceOption(
        title: "uPNP",
        description: @[
          "The Archivist node will attempt to use only uPNP."
        ],
        warning: "",
        action: setNatUpnp
      ),
      ChoiceOption(
        title: "PMP",
        description: @[
          "The Archivist node will attempt to use only PMP."
        ],
        warning: "",
        action: setNatPmp
      ),
      ChoiceOption(
        title: "extIP",
        description: @[
          "The Archivist node will use your external IP address."
        ],
        warning: "Setup will connect to a Durability-Labs server to determine your external IP address",
        action: setNatExtIp
      ),
      ChoiceOption(
        title: "extIP (manual)",
